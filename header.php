...
$rol = $_SESSION['rol'] ?? 0; // 1=Admin, 2=Recursos Humanos, 3=Jefatura, 4=Colaborador
...
<aside id="mainSidebar">
    ...
    <nav class="sidebar-menu nav flex-column">
        <?php if ($rol == 1): // ADMINISTRADOR ?>
            ...
            <a class="nav-link <?= isActive('personas.php') ?>" href="personas.php"><i class="bi bi-person-lines-fill"></i> Gestión de Personas</a>
         ...
         <?php elseif ($rol == 2): // COLABORADOR ?>
            ...
            <a class="nav-link <?= isActive('solicitud_incapacidad.php') ?>" href="solicitud_incapacidad.php"><i class="bi bi-emoji-dizzy"></i> Solicitar Incapacidad</a>
            <a class="nav-link <?= isActive('horas_extra.php') ?>" href="horas_extra.php"><i class="bi bi-clock-history"></i> Solicitar Horas Extra</a>
